...
<div class="container">
  ...
  <br><br>
    ...
    <div class="panel panel-default">
        ...
        <form  method="post" action="/attendance_mark2">
        @csrf    
                ...
                <table class="table">
                    ...
                    @if( $att->is_saved2==0)
                        <tr>
                            ...
                            <td>
                             <input type="checkbox"  name="my_checkbox2[]"  value="{{$att->id}}">
                                                        @else
                                                         @if($att->attend_mark2==1)
                                                           <td>{{ $att->id }}</td>
                                     ...
                                     @if( $att->is_saved2==1)
                                            <a href="{{ route('tharu2') }}" class="btn btn-primary" title="Edit Atts">
