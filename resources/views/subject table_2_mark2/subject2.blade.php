...
<div class="container">
  ...
  <br><br>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-with-table">
            ...
            <form  method="post" action="/attendance_mark1">
                                    @csrf    
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    @if( $att->is_saved1==0)
                        <tr>
                           <td>{{ $att->id }}</td>
                            ...
                            <td>
                                        <input type="checkbox"  name="my_checkbox1[]"  value="{{$att->id}}">
                                                        @else
                                                         @if($att->attend_mark1==1)
                                                           <td>{{ $att->id }}</td>
                  ...
                  @if( $att->is_saved1==0)
                                     ...
                                     @if( $att->is_saved1==1)
                                            <a href="{{ route('tharu1', $att->id ) }}" class="btn btn-primary" title="Edit Atts">
 ...
 <table class="table">
  ...
  <th>          
                            ...
                            @if( $att->is_saved1==1)
                                        <form class="form-horizontal" method="post" action="{{ route('hours.index', $data->id ) }}" >  
                                            {{--<label style="text-align: center;  position: relative ; left:3%" ><b>Hours :</b> :</label>
                                                <input type="number" placeholder="Enter lecture hours"  name="hour" minlength="1" maxlength="200"  max="10" min="1" style="background-color:yellow; text-align: center;  position: relative ; left:3%" >    
                                            --}}
