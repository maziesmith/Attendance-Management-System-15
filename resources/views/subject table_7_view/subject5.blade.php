            ...
            <div class="col-md-12">
                <div class=>
                      <a href="{{ url('/home') }}" title="Go back to main menu"><button class="btn btn-warning "><i class="fa fa-arrow-left" aria-hidden="true"></i>Admin Menu  </button></a>
                       <a href="{{ url('/table__course__3g__students') }}" title="Go back to main menu"><button class="btn btn-primary "><i class="fa fa-arrow-left" aria-hidden="true"></i>Attendance Menu  </button></a>                        
  <br><br>                     
    ...
    <th>Course Name :{{$data->name}}</th>
     ...
     <th>No of Lectures :{{$SingleData->nooflectures4}} </th>  
                        ...
                        <form method="GET" action="{{ route('1s_sub1.1s_sub1.index_3G_sub1', $data->id ) }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
