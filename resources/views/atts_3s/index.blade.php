        ...
        <div class="row">
            <div class="col-md-12">
                <div class=>
                     ...
                     <a href="{{ url('/atts_3s') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level2->level}}  </button></a>
...
<div class="panel-body panel-body-with-table">
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('atts_3s.atts_3s.create') }}" class="btn btn-success" title="Create New Atts 3S">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true">Add new</span>
                              ...
                              <div class="panel-body panel-body-with-table">
                                <form method="GET" action="{{ url('/atts_3s') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
        ...
        <div class="alert alert-success">
            ...
            <div class="table-responsive">
                ...
                <table class="table ">
                    ...
                    <tbody>
                    @foreach($atts3sObjects as $atts3s)
                        <tr>
                            <td>{{ $atts3s->id }}</td>
                            <td>{{ $atts3s->Reg_No }}</td>
                            <td>{{ $atts3s->name }}</td>
                            ...
                            <td>
                                <form method="POST" action="{!! route('atts_3s.atts_3s.destroy', $atts3s->id) !!}" accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                   
                                        <a href="{{ route('atts_3s.atts_3s.edit', $atts3s->id ) }}" class="btn btn-primary" title="Edit Atts 3S">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                        <button type="submit" class="btn btn-danger" title="Delete Atts 3S" onclick="return confirm(&quot;Delete Atts 3S?&quot;)">
