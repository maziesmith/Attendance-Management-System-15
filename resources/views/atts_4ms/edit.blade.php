...
@section('content')
 <div class="container">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('atts_4ms.atts_4m.update', $atts4m->id) }}" id="edit_atts_4m_form" name="edit_atts_4m_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
