        ...
        <div class="row">
            <div class="col-md-12">
                <div class=>
                     ...
                     <a href="{{ url('/atts_3ms') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level3->level}}</button></a>
   ...
   <br>
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('atts_3ms.atts_3ms.create') }}" class="btn btn-success" title="Create New Atts 3Ms">
       ...
       <div class="panel-body panel-body-with-table">
             <form method="GET" action="{{ url('/atts_3ms') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                    @foreach($atts3msObjects as $atts3ms)
                        <tr>
                            <td>{{ $atts3ms->id }}</td>
                            <td>{{ $atts3ms->Reg_No }}</td>
                            <td>{{ $atts3ms->name }}</td>
                            
                            <td>

                                <form method="POST" action="{!! route('atts_3ms.atts_3ms.destroy', $atts3ms->id) !!}" accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                    
                                        <a href="{{ route('atts_3ms.atts_3ms.edit', $atts3ms->id ) }}" class="btn btn-primary" title="Edit Atts 3Ms">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                        <button type="submit" class="btn btn-danger" title="Delete Atts 3Ms" onclick="return confirm(&quot;Delete Atts 3Ms?&quot;)">
