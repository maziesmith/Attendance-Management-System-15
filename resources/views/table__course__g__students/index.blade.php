        ...
        <div class="row">
            <div class="col-md-12">
                  <div class=>
                     ...
                     <a href="{{ url('/table__course__g__students') }}" title="EditData"><button class="btn btn-danger"><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level1->level}} </button></a>
                ...
                <table class="table table-responsive ">
                    ...
                    @foreach($tableCourseGStudents as $tableCourseGStudent)
                        <tr>
                            ...
                            <td>{{ $tableCourseGStudent->Lecture_id }}</td>
                            ...
                            <td>
                                        ...
                                        <a href="{{ route('1s_sub1.1s_sub1.index_2G_sub1', $tableCourseGStudent->id ) }}" class="btn btn-warning" title="Edit Table  Course  S  Students">
