                  ...
                  <div class=>
                     ...
                     <a href="{{ url('/table__course__g__students') }}" title="EditData"><button class="btn btn-success"><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level1->level}} </button></a>
                      <a href="{{ url('/table__course__3g__students') }}" title="EditData"><button class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level2->level}} </button></a>
                       <a href="{{ url('/table__course__3m__students') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level3->level}}</button></a>
                    ...
                    @foreach($tableCourseGStudents as $tableCourseGStudent)
                        <tr>
                            ...
                            <td>
                                        ...
                                        <a href="{{ route('table__course__3m__students.table__course__3m__student.edit', $tableCourseGStudent->id ) }}" class="btn btn-primary" title="Edit Table  Course  G  Student">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                        <a href="{{ route('1s_sub1.1s_sub1.index_3M_sub1', $tableCourseGStudent->id ) }}" class="btn btn-warning" title="Edit Table  Course  S  Students">
