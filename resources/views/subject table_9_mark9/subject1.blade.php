    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                <form  method="post" action="/attendance_markM4">
                                    @csrf
                    ...
                    @if( $att->is_saved==0)
                        <tr>
                          ...
                          <input type="checkbox"  name="my_checkbox[]"  value="{{$att->id}}">
                                     ...
                                     @if( $att->is_saved==1)
                                            <a href="{{ route('tharuM4') }}" class="btn btn-primary" title="Edit Atts">
 ...
 <table class="table">
                    <thead>
                        <tr class="tr btn-dark">
                           <th>  
                               @if( $att->is_saved==1)
                               <form class="form-horizontal" method="post" action="{{ route('hour4m.index', $data->id ) }}" >  
    ...
    <label style="text-align: center;  position: relative ; left:3%" ><b>Hall :</b> :</label>
        ...
        <button class="btn btn-primary" type="submit" name="submit2"  style="position: relative ; left:7%  ">submit the attendance </button> <input type="hidden" name="_token" value="{{ csrf_token() }}">
    </form> </th>
