                    ...
                    @foreach($atts as $att)
                        <tr>
                            ...
                            @if( $att->attend_mark1 )
                                 ...
                                 <a href="{{ route('att4ms.att1.edit1s', $att->id ) }}"  title="change the attendance" ><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>Not Attended  </button></a> 
                                
                            @else
                              <a href="{{ route('att4ms.att1.edit1s', $att->id ) }}"  title="change the attendance" ><button class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i>  Attended </button></a> 
