        ...
        <div class="row">
            <div class="col-md-12">
                <div class=>
                     ...
                     <br><br>
                      <a href="{{ url('/atts_1gs') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level->level}} </button></a>
   ...
   <br>
    ...
    <div class="panel-body panel-body-with-table">
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('atts_1gs.atts_1gs.create') }}" class="btn btn-success" title="Create New Atts 1Gs">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true">Add new</span>
                                ...
                                <div class="panel-body panel-body-with-table">
       <form method="GET" action="{{ url('/atts_1gs') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
    ...
    @endif
            <div class="table-responsive">
                ...
                <table class="table  ">
                    ...
                    <tbody>
                    @foreach($atts1gsObjects as $atts1gs)
                        <tr>
                                <td>{{ $atts1gs->id }}</td>
                            <td>{{ $atts1gs->Reg_No }}</td>
                            <td>{{ $atts1gs->name }}</td>
                            

                            <td>

                                <form method="POST" action="{!! route('atts_1gs.atts_1gs.destroy', $atts1gs->id) !!}" accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                       
                                        <a href="{{ route('atts_1gs.atts_1gs.edit', $atts1gs->id ) }}" class="btn btn-primary" title="Edit Atts 1Gs">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                        <button type="submit" class="btn btn-danger" title="Delete Atts 1Gs" onclick="return confirm(&quot;Delete Atts 1Gs?&quot;)">
