    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                <form  method="post" action="/attendance_markG3">
                                    @csrf
                    ...
                    @if( $att->is_saved==0)
                        <tr>
                          ...
                          <input type="checkbox"  name="my_checkbox[]"  value="{{$att->id}}">
                                     ...
                                     @if( $att->is_saved==1)
                                            <a href="{{ route('tharuG3') }}" class="btn btn-primary" title="Edit Atts">
 ...
 <table class="table">
                    <thead>
                        <tr class="tr btn-dark">
                           <th>  
                               @if( $att->is_saved==1)
                               <form class="form-horizontal" method="post" action="{{ route('hour3g.index', $data->id ) }}" >  
