        ...
        <div class="row">
            <div class="col-md-12">
                  <div class=>
                     ...
                     <a href="{{ url('/1g_attendance') }}" title="EditData"><button class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level->level}}</button></a>
                     <a href="{{ url('/2g_attendance') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level1->level}} </button></a>
                    ...
                    @foreach($tableCourseGStudents as $tableCourseGStudent)
                        <tr>
                            ...
                            <td>
                                        ...
                                        <a href="{{ route('2g_mark1.2g_mark1.index', $tableCourseGStudent->id ) }}" class="btn btn-primary" title="Edit Table  Course  G  Student">
