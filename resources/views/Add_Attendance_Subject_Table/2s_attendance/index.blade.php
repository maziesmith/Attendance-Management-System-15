            ...
            <div class="col-md-12">
                  <div class=>
                    ...
                    <a href="{{ url('/1g_attendance') }}" title="EditData"><button class="btn btn-primary "><i class="fa fa-arrow-left" aria-hidden="true"></i>General CS attendance table </button></a>
                     ...
                     <a href="{{ url('/2s_attendance') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level1->level}} </button></a>
                    ...
                    @foreach($tableCourseSStudentsObjects as $tableCourseSStudents)
                        <tr>
                            ...
                            <td>
                                        ...
                                        <a href="{{ route('2s_mark2.2s_mark2.index', $tableCourseSStudents->id ) }}" class="btn btn-primary" title="Edit Table  Course  S  Students">
