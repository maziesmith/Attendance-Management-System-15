...
<div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class=>
                      ...
                      <a href="{{ url('/2g_attendance') }}" title="Go back to main menu"><button class="btn btn-primary "><i class="fa fa-arrow-left" aria-hidden="true"></i>Attendance Menu  </button></a>                                               
  <br><br>
                    ...
                    @foreach($atts as $att)
                        <tr>
                            ...
                            @if( $att->attend_mark1 )
                                 ...
                                 <a href="{{ route('att2gs.att1.edit1s', $att->id ) }}"  title="change the attendance" ><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>Not Attended  </button></a> 
                                
                            @else
                              <a href="{{ route('att2gs.att1.edit1s', $att->id ) }}"  title="change the attendance" ><button class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i>  Attended </button></a> 
 ...
 <table class="table">
  ...
  <th>  <form class="form-horizontal" method="post" action="{{ route('hour2g.index', $data->id ) }}" >  
