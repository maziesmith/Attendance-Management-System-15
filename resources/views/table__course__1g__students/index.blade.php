        ...
        <div class="row">
            <div class="col-md-12">
                  <div class=>
                     ...
                     <br><br>
                      <a href="{{ url('/table__course__1g__students') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level->level}} </button></a>
                    ...
                    @foreach($tableCourseGStudents as $tableCourseGStudent)
                        <tr>
                            ...
                            <td>
                                        ...
                                        <a href="{{ route('table__course__1g__students.table__course__1g__student.edit', $tableCourseGStudent->id ) }}" class="btn btn-primary" title="Edit Table  Course  G  Student">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                           <a href="{{ route('1s_sub1.1s_sub1.index_1G_sub1', $tableCourseGStudent->id ) }}" class="btn btn-warning" title="Edit Table  Course  G  Students">
