        ...
        <div class="row">
            <div class="col-md-12">
                <div class=>
                     ...
                     <a href="{{ url('/atts') }}" title="EditData"><button class="btn btn-danger"><i class="fa fa-arrow-left" aria-hidden="true"></i>Direct CS  student course table</button></a>
                     ...
                     <a href="{{ url('/atts_4s') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true">{{$level3->level}}</i> </button></a>
                 ...
                 <div class="card">
                    <div class="card-header">Table of {{$level3->level}} students</div>
                    <div class="card-body">
...
<div class="panel-body panel-body-with-table">
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('atts_4s.atts_4s.create') }}" class="btn btn-success" title="Create New Atts 4S">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true">Add new</span>
                              ...
                              <div class="panel-body panel-body-with-table">
        <form method="GET" action="{{ url('/atts_4s') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
    ...
    @endif
            <div class="table-responsive">
                ...
                <table class="table ">
                    ...
                    <tbody>
                    @foreach($atts4sObjects as $atts4s)
                        <tr>
                            <td>{{ $atts4s->id }}</td>
                            <td>{{ $atts4s->Reg_No }}</td>
                            <td>{{ $atts4s->name }}</td>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{!! route('atts_4s.atts_4s.destroy', $atts4s->id) !!}" accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                    
                                        <a href="{{ route('atts_4s.atts_4s.edit', $atts4s->id ) }}" class="btn btn-primary" title="Edit Atts 4S">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                        <button type="submit" class="btn btn-danger" title="Delete Atts 4S" onclick="return confirm(&quot;Delete Atts 4S?&quot;)">
