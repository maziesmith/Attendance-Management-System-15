                    ...
                    @foreach($atts as $att)
                        <tr>
                            ...
                            @if($att->attend_mark5 )
                                 ...
                                 <a href="{{ route('edit5s', $att->id ) }}"  title="change the attendance" ><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>Not Attended  </button></a> 
                                
                            @else
                              <a href="{{ route('edit5s', $att->id ) }}"  title="change the attendance" ><button class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i> Attended </button></a> 
