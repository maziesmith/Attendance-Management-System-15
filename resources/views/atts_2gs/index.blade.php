        ...
        <div class="row">
            <div class="col-md-12">
                <div class=>
                     ...
                     <a href="{{ url('/atts_2gs') }}" title="EditData"><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>{{$level1->level}} </button></a>
   ...
   <br>
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('atts_2gs.atts_2gs.create') }}" class="btn btn-success" title="Create New Atts 2Gs">
        ...
        <div class="panel-body panel-body-with-table">
             <form method="GET" action="{{ url('/atts_2gs') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
    ...
    @endif
            ...
            <div class="table-responsive">
                ...
                <table class="table ">
                    ...
                    <tbody>
                    @foreach($atts2gsObjects as $atts2gs)
                        <tr>
                            <td>{{ $atts2gs->id}}</td>
                            <td>{{ $atts2gs->Reg_No }}</td>
                            <td>{{ $atts2gs->name }}</td>
                            

                            <td>

                                <form method="POST" action="{!! route('atts_2gs.atts_2gs.destroy', $atts2gs->id) !!}" accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                      
                                        <a href="{{ route('atts_2gs.atts_2gs.edit', $atts2gs->id ) }}" class="btn btn-primary" title="Edit Atts 2Gs">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span>
                                        </a>

                                        <button type="submit" class="btn btn-danger" title="Delete Atts 2Gs" onclick="return confirm(&quot;Delete Atts 2Gs?&quot;)">
