...
<div class="container">
                    ...
                    @foreach($att4s as $att4)
                        <tr>
                            ...
                            @if( $att4->attend_mark )
                                 ...
                                 <a href="{{ route('atts_4s.att4s.edit', $att4->id ) }}"  title="change the attendance" ><button class="btn btn-danger "><i class="fa fa-arrow-left" aria-hidden="true"></i>Not Attended </button></a> 
                                
                            @else
                              <a href="{{ route('atts_4s.att4s.edit', $att4->id ) }}"  title="change the attendance" ><button class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i> Attended</button></a> 
 ...
 <table class="table">
        ...
        <input type="number"  name="name" placeholder="Enter lecture hours"  name="hour" minlength="1" maxlength="200"  max="10" min="1" required="true"  style="background-color:yellow; text-align: center;  position: relative ; left:3%" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
