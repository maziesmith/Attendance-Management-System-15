    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                     <form  method="post" action="/attendance_markS4">
                                    @csrf
                        ...
                        <tr>
                            ...
                            <td>
                              <input type="checkbox"  name="my_checkbox[]"  value="{{$att->id}}">
                                     ...
                                     @if( $att->is_saved==1)
                                            <a href="{{ route('tharuS4') }}" class="btn btn-primary" title="Edit Atts">
        ...
        <form class="form-horizontal" method="post" action="{{ route('hours4s.index', $data->id ) }}" >  
