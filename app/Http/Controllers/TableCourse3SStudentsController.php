...
class TableCourse3SStudentsController extends Controller
{
    ...
    {    $level = DB::table('Level')
       ...
       $tableCourse3SStudentsObjects  = table__course__s__students::where('Level', '=', "3S") ->latest()->paginate(60);
       return view('table__course__3s__students.index', compact('tableCourse3SStudentsObjects','items','level','level1','level2','level3'));
    ...
    {   
      ...
      $tableCourse3SStudentsObjects  = table__course__s__students::where('Level', '=', "3S") ->latest()->paginate(60);
       return view('Add_Attendance_Subject_Table.3s_attendance.index', compact('tableCourse3SStudentsObjects','level','level1','level2','level3'));
    }
     ...
     public function edit($id)
   {
       ...
       return view('table__course__s__students.edit3s', compact('tableCourseSStudents','dat'));
   }
     ...
     public function edit1($id)
   {
       ...
       return view('table__course__s__students.edit2', compact('tableCourseSStudents','dat'));
   }
