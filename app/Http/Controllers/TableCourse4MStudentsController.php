...
class TableCourse4MStudentsController extends Controller
{
    ...
    {   $level = DB::table('Level')
        ...
        $tableCourseGStudents = table__course__g__student::where('Level', '=', "4M") ->latest()->paginate(60);
       
             $items = DB::table('precentages')
             ->select('precentage')
             ->where('Level','=', "2S")->first();
        return view('table__course__4m__students.index', compact('tableCourseGStudents','items','level1','level','level2','level3','level4'));
    }
    ...
    {    $level = DB::table('Level')
        ...
        $tableCourseGStudents = table__course__g__student::where('Level', '=', "4M") ->latest()->paginate(60);
        return view('Add_Attendance_Subject_Table.4m_attendance.index', compact('tableCourseGStudents','level','level1','level2','level3','level4'));
    }
     ...
     public function edit($id)
   {
       ...
       return view('table__course__g__students.edit4m', compact('tableCourseGStudent','dat'));
   }
       ...
       public function edit1($id)
   {
       ...
       return view('table__course__g__students.edit9', compact('tableCourseGStudent','dat'));
