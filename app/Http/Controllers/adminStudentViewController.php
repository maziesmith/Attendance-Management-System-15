...
class adminStudentViewController extends Controller
{
    ...
    public function profileview(request $request)
    {
     ...
     try{
        ...
        $id1 = $request->RegistrationNo;
        $max = DB::table('tblstudents')
        ->where('RegistrationNo','=',$id1)
    ...
    if($data)
    {
        foreach($data as $sub)
        {
            ...
            ->get();  
            return view('student.all', compact('data','dat','da','d','abc','abd','abe','abf','abg','abh','abi','abj','infor','info','inf','in','i')); 
        }
    }
    if($dat)
    {
    ...
    if($i)
    {
        ...
        ->with('error_message', 'Your Registration Number is not in there! Please Try again');
}
