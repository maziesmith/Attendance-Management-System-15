...
class Atts4msController extends Controller
{
   ...
   public function result()
   {
          ...
          DB::table('atts_4ms')-> update(['is_saved'=>0]);
      ...
      public function result7()
   {
          ...
          DB::table('atts_4ms')-> update(['is_saved7'=>0]);
           return redirect::to(url::previous());
   } 
   ...
   {   
    ...
    try{
        if($id==14){
            ...
            DB::table('atts_4ms')-> update(['hours'=>$diff]);  
            DB::table('atts_4ms')-> update(['hall'=>$request->hall]);
            DB::table('atts_4ms')-> update(['date'=>$request->date]);
            DB::table('atts_4ms')-> update(['Start_Time'=>$request->ST]);
            DB::table('atts_4ms')-> update(['End_Time'=>$request->ET]);
            ...
            DB::table('atts_4ms')-> update(['is_saved'=>0]); 
             ...
             if($id==15){
                ...
                DB::table('atts_4ms')-> update(['hours1'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall1'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date1'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time1'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time1'=>$request->ET]);
            ...
            DB::table('atts_4ms')-> update(['is_saved1'=>'0']); 
             ...
             if($id==16){
              ...
              $st = Carbon::parse($request->ST);
                ...
                DB::table('atts_4ms')-> update(['hours2'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall2'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date2'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time2'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time2'=>$request->ET]); 
            ...
            if($id==18){
                ...
                DB::table('atts_4ms')-> update(['hours3'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall3'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date3'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time3'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time3'=>$request->ET]); 
            ...
            if($id==19){
                ...
                DB::table('atts_4ms')-> update(['hours4'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall4'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date4'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time4'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time4'=>$request->ET]); 
            ...
            if($id==20){
                ...
                DB::table('atts_4ms')-> update(['hours5'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall5'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date5'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time5'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time5'=>$request->ET]); 
            ...
            if($id==21){
             ...
             $st = Carbon::parse($request->ST);
                ...
                DB::table('atts_4ms')-> update(['hours6'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall6'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date6'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time6'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time6'=>$request->ET]); 
            ...
            if($id==46){
                ...
                DB::table('atts_4ms')-> update(['hours7'=>$diff]);  

                DB::table('atts_4ms')-> update(['hall7'=>$request->hall]);

            DB::table('atts_4ms')-> update(['date7'=>$request->date]);

            DB::table('atts_4ms')-> update(['Start_Time7'=>$request->ST]);

            DB::table('atts_4ms')-> update(['End_Time7'=>$request->ET]); 
    ...
    public function ray(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved'=>1]); 
        ...
        public function ray1(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark1'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark1'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved1'=>1]); 
        ...
        public function ray2(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark2'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark2'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved2'=>1]); 
        ...
        public function ray3(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark3'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark3'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved3'=>1]); 
        ...
        public function ray4(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark4'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark4'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved4'=>1]); 
        ...
        public function ray5(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark5'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark5'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved5'=>1]); 
        ...
        public function ray6(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark6'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark6'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved6'=>1]); 
        ...
        public function ray7(Request $request)
    {
      DB::table('atts_4ms')-> update(['attend_mark7'=>0]); 
        ...
        foreach ($record as $value) {
            DB::table('atts_4ms')->where('id', $value)->update(['attend_mark7'=>1]);
        }
        }    
        
        DB::table('atts_4ms')-> update(['is_saved7'=>1]); 
